# Generated by Django 5.0.2 on 2024-04-08 19:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aquisition_cost', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.CharField(choices=[('Technical', 'Technical'), ('Sales & Marketing', 'Sales & Marketing'), ('HelpDesk', 'HelpDesk'), ('Finance', 'Finance'), ('Admin', 'Admin')], max_length=50)),
                ('id_number', models.CharField(blank=True, default=None, max_length=255, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Subjects',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brand', models.CharField(blank=True, default=None, max_length=255)),
                ('serial_number', models.CharField(max_length=255)),
                ('retrieved_by', models.CharField(blank=True, max_length=255, null=True)),
                ('delivered_date', models.DateField(blank=True, null=True)),
                ('retrieval_date', models.DateField(blank=True, null=True)),
                ...
                ('supplier', models.CharField(blank=True, default=None, max_length=255, null=True)),
                ('current_status', models.CharField(choices=[('Retrieved', 'Retrieved'), ('Market', 'Market'), ('Assigned to staff', 'Assigned to staff'), ('Disposed', 'Disposed'), ('New', 'New')], max_length=50)),
                ('agency', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='frontend.agency')),
                ('delivered_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='frontend.staff')),
                ('disposed_by', models.ManyToManyField(blank=True, related_name='disposed_equipment', to='frontend.staff')),
            ],
        ),
        migrations.CreateModel(
            name='DisposedComputer',
            fields=[
                ('disposed_id', models.AutoField(primary_key=True, serialize=False)),
                ('disposal_date', models.DateTimeField(blank=True, null=True)),
                ('disposal_reason', models.CharField(blank=True, default=None, max_length=255)),
                ('disposal_details', models.TextField(blank=True, default=None)),
                ('equipment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='frontend.equipment')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transaction_type', models.CharField(choices=[('Bought', 'Bought'), ('Taken to market', 'Taken to market'), ('Retrieved from market', 'Retrieved from market'), ('Assigned to staff', 'Assigned to staff')], max_length=50)),
                ('transaction_date', models.DateTimeField(blank=True, null=True)),
                ('transaction_details', models.TextField(blank=True, default=None)),
                ('recipient_type', models.CharField(choices=[('Market', 'Market'), ('Staff', 'Staff'), ('Disposal', 'Disposal')], max_length=50)),
                ('equipment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='frontend.equipment', verbose_name='Equipment')),
            ],
        ),
        migrations.CreateModel(
            name='Admin_Model',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('storage_condition', models.CharField(choices=[('Good', 'Good'), ('Needs repair', 'Needs repair'), ('Disposed', 'Disposed')], max_length=50)),
                ('equipment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='frontend.equipment', verbose_name='Equipment')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password', models.CharField(default=None, max_length=255, verbose_name='Password')),
                ...
                ('schoolpaycode', models.CharField(blank=True, max_length=10, verbose_name='School Pay Code')),
